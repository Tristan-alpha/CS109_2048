...
public class Customized {
    ...
    public Customized(int xCount, int yCount) {
//        super(xCount, yCount);
        this.X_COUNT = xCount;
        this.Y_COUNT = yCount;
        this.numbers = new int[this.X_COUNT][this.Y_COUNT];
        this.buttonStatus = new int[X_COUNT][Y_COUNT];
//        this.initialNumbers();
//        this.initialNumbers(buttonStatus);
    }
    ...
    public void initialNumbers() {
        for (int i = 0; i < numbers.length; i++) {
            for (int j = 0; j < numbers[i].length; j++) {
                ...
                if (buttonStatus[i][j] == 1) {
                    numbers[i][j] = 0;
                }

                if (buttonStatus[i][j] == 0) {
                    numbers[i][j] = -1;
                }
            }
        }
    ...
    public void generateANumber(int number) {
        ...
        if (numbers[randomX][randomY] == 0 && buttonStatus[randomX][randomY] == 1) {
        ...
        for (int i = 0; i < numbers.length; i++) {
            for (int j = numbers.length - 2; j >= 0; j--) {
                ...
                for (int k = 0; j + k < numbers.length - 1; k++) {
                    if (buttonStatus[i][j + k] == 1 && buttonStatus[i][j + k + 1] == 1) {
    ...
    public void moveUp() {
        for (int i = 0; i < numbers.length; i++) {
            for (int j = 1; j < numbers.length; j++) {
                ...
                for (int k = 0; j - k > 0; k++) {
                    if (buttonStatus[j - k][i] == 1 && buttonStatus[j - k - 1][i] == 1) {
...
//    }
    ...
    public boolean isGameOver() {
        ...
        for (int i = 0; i < numbers.length; i++) {
            for (int j = 0; j < numbers[i].length; j++) {
                if (numbers[i][j] == 0 && buttonStatus[i][j] == 1) {
                    return false;
                }
            }
        }
        ...
        for (int i = 0; i < numbers.length; i++) {
            for (int j = 0; j < numbers[0].length; j++) {
                ...
                if (buttonStatus[i][j] == 1 && buttonStatus[i + 1][j] == 1 && i < numbers.length - 1 && numbers[i][j] == numbers[i + 1][j]) {
                    return false;
                }

                if (buttonStatus[i][j + 1] == 1 && buttonStatus[i][j] == 1 && j < numbers[0].length - 1 && numbers[i][j] == numbers[i][j + 1]) {
                    return false;
                }
            }
        }
...
//    }
    ...
    Media collison = new Media(getClass().getResource("/CollisonEffect.mp3").toExternalForm());
    MediaPlayer collisionPlayer = new MediaPlayer(collison);
